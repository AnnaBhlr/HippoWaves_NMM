...
%%
% Define File Paths
data_path_1 = '/Volumes/NEWYSNG/Anna/HippocampalCorticalModeling/cortex2hippo/Output_Hippowaves_slow_0p20_neg/20250919_140940/FlowPotential_cortex.csv'; 
[~, name1] = fileparts(data_path_1);
data_path_2 = '/Volumes/NEWYSNG/Anna/HippocampalCorticalModeling/cortex2hippo/Output_Hippowaves_slow_0p20_pos/20250912_220941/FlowPotential_cortex.csv';
[~, name2] = fileparts(data_path_2);
...
function process_svd_and_plot(data, dataset_name, save_dir, hemiFaces, hemiVertices)
    ...
    for i = 1:3
        ...
        el = 15;
        figure;
        figure_surf2(hemiFaces, hemiVertices, U(:, i), colormap, az, el);
        hold on;
    ...
    saveas(gcf, fullfile(save_dir, sprintf('%s_Right_Singular_Vectors.png', dataset_name))); % Save figure
    %close(gcf); % Close figure to avoid clutter
end
